          ...
          <div className="space-y-8">
            <div className="text-center space-y-4 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                Designed for everyone - voice input, screen reader support, and plain language guidance.
              </p>
            </div>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Answer simple questions about your issue. Use voice input or type your responses.
                      </p>
                    </div>
                    <div className="space-y-2">
                ...
                <CardContent className="p-6">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      WCAG 2.2 AA compliant • Screen reader optimized • Voice input support • 
